...
/* private functions */
static int  _insert  (LIST*  pList, NODELIST* pPre,  void* dataInPtr);
static void _delete  (LIST*  pList, NODELIST*  pPre, NODELIST*  pLoc, void** dataOutPtr);
static int  _search  (LIST*  pList, NODELIST** pPre, NODELIST** pLoc, void*  pArgu);
...
//	Statements 
	if ((temp = (NODELIST*)malloc(sizeof(*(pList->head)))))
	   {
	    free (temp);
	    return 0;
	   } // if 
...
*/
void _delete (LIST* pList, NODELIST*  pPre,
              NODELIST* pLoc,  void** dataOutPtr)
{
//	Statements 
	*dataOutPtr = pLoc->dataPtr;
	if (pPre == NULL)
...
*/
static int _insert (LIST* pList, NODELIST* pPre,
                     void* dataInPtr)
{
//	Local Definitions 
	NODELIST* pNew;
...
//	Statements 
	if (!(pNew = (NODELIST*) malloc(sizeof(NODELIST))))
	   return 0;
